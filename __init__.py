...
bl_info = {
    "name": "Cineloom - AI Film Assembly",
    "author": "Cineloom contributors (forked from Pallaidium by tintwotin)",
    "version": (0, 1, 0),
    "blender": (5, 2, 0),
    "location": "Video Sequence Editor > Sidebar > Cineloom",
    "description": "Model-agnostic AI film-assembly workbench in the VSE — local or remote GPU backend",
    "category": "Sequencer",
}
