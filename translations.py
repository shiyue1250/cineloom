...
_ZH = {
    ...
    (_C, "Channel"): "渠道",
    (_C, "Control"): "控制方式",
    (_C, "Shots (continuous):"): "镜头（连续）：",
    (_C, "Add Shot"): "添加镜头",
    (_C, "Shot"): "镜头",
    (_C, "Negative"): "负面",
    (_C, "Seconds"): "秒数",
    (_C, "Reference"): "参考图",
    (_C, "Storyboard shots (empty = single clip):"): "分镜镜头（留空=单段）：",
    (_C, "First Frame"): "首帧",
    (_C, "Last Frame"): "尾帧",
    (_C, "Frames to interpolate:"): "补间用的首尾帧：",
    (_C, "Sec"): "秒",
    (_C, "Canny (edges)"): "Canny（边缘）",
    (_C, "Depth"): "深度",
    (_C, "Pose (OpenPose)"): "姿态（OpenPose）",
    (_C, "Add Channel"): "添加渠道",
